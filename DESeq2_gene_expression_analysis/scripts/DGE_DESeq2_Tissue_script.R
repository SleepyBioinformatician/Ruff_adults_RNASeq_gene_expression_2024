...
# To analyze a different tissue, subset the metadata file for a different tissue (line #21)
# List of available tissues: (Adr, A+TnA, Blo, Gon, Hyp, Liv, LS, NC, Pit, POM, Rap, VTA+SN)
# Batch effect has to be accounted only when analyzing Adrenal glands (ADR) and Pre-optic area (POM)
# Samples of other tissues have been sequenced in the same batches
# Change the script to remove/add "Batch" from the exp design (mask or unmask lines #23, #29 and #30 accordingly)
